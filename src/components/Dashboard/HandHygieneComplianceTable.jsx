  ...
  if (loading) {
    return (
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Hand Hygiene Compliance by Month</h3>
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Hand Hygiene Compliance by Month</h3>
        <div className="text-sm text-gray-500">Based on technique assessment</div>
      </div>
        ...
        <table className="min-w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-center py-3 px-4 font-medium text-green-700 bg-green-50 min-w-[120px]">
                Adequate
              </th>
              <th className="text-center py-3 px-4 font-medium text-yellow-700 bg-yellow-50 min-w-[140px]">
                Needs Improvement
              </th>
              <th className="text-center py-3 px-4 font-medium text-red-700 bg-red-50 min-w-[130px]">
                No Hand Hygiene
              </th>
            </tr>
          </thead>
            ...
            {complianceData.length > 0 ? (
              complianceData.map((row, idx) => (
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className={`py-3 px-4 text-center`}>
                    <span
                      className={`inline-block px-3 py-1 rounded-md text-sm ${getComplianceColor(
                        'adequate',
                        row.adequate
                      )}`}
                    >
              ...
              <tr>
                <td colSpan="4" className="text-center py-8 text-gray-500">
                  No hand hygiene audit data available for the selected period.
                  <br />
      ...
      <div className="mt-4 text-xs text-gray-500 text-center">
        Based on WHO hand hygiene technique assessment and time duration criteria
      </div>
    </div>
  );
};
